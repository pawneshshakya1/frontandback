...
export const WithdrawScreenPartner = ({ navigation }: any) => {
    ...
    <View style={styles.container}>
      ...
      <View style={[styles.header, { paddingTop: insets.top + 12 }]}>
        ...
        <TouchableOpacity
          ...
          accessibilityLabel="Get help with withdrawal"
          onPress={() => Alert.alert('Help', 'Contact support for withdrawal help')}
        >
            ...
            {method === "UPI" && (
              <View style={styles.upiInputArea}>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => Alert.alert('Coming Soon', 'Verification will be available soon')}
                >
        ...
        <View style={styles.section}>
          ...
          <View style={[styles.sliderContainer, maxWithdrawable === 0 && { opacity: 0.5 }]}>
            <Slider
              ...
              minimumTrackTintColor={maxWithdrawable === 0 ? "#555" : COLORS.primary}
              maximumTrackTintColor="#333333"
              thumbTintColor={maxWithdrawable === 0 ? "#555" : COLORS.primary}
              step={1}
              value={amount}
