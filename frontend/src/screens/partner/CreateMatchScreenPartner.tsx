...
const Step1 = ({
  ...
  <View style={styles.stepContainer}>
          ...
          >
            <Text
              style={[
                ...
                eventTier === tier && styles.gameTypeButtonTextActive,
              ]}
            >
              {tier}
            </Text>
    ...
    {eventTier === "SPONSORED" && (
      ...
      >
        <Text
          style={[styles.label, { color: COLORS.primary, marginBottom: 4 }]}
        >
          Sponsor Details
        </Text>
        ...
        <View style={styles.inputGroup}>
          ...
          <TextInput
            ...
            onChangeText={(t) =>
              setSponsorDetails({ ...sponsorDetails, name: t })
            }
        ...
        <View style={styles.inputGroup}>
          ...
          <TextInput
            ...
            onChangeText={(t) =>
              setSponsorDetails({ ...sponsorDetails, logo: t })
            }
            placeholder="https://..."
            placeholderTextColor={`${COLORS.textMuted}33`}
          />
        ...
        <View style={styles.inputGroup}>
          ...
          <TextInput
            ...
            onChangeText={(t) =>
              setSponsorDetails({ ...sponsorDetails, website: t })
            }
            placeholder="https://..."
            placeholderTextColor={`${COLORS.textMuted}33`}
          />
          ...
          {eventTier === "PREMIUM" && (
            <View
              style={{
                ...
                top: 12,
                right: 12,
                backgroundColor: COLORS.eliteSupreme,
                paddingHorizontal: 8,
                paddingVertical: 4,
                borderRadius: 8,
                zIndex: 10,
          ...
          <View style={styles.previewGrid}>
            ...
            <View style={styles.previewStat}>
              ...
              <View style={[styles.previewStatRow, { marginTop: 4 }]}>
                ...
                />
                <Text
                  style={[styles.previewStatValue, { color: COLORS.primary }]}
                >
                  ${prizePool || "0.00"}
                </Text>
              </View>
...
export const CreateMatchScreenPartner = ({ navigation, route }: any) => {
      ...
      <View style={styles.progressBarWrapper}>
        <View
          style={[
            ...
            {
              backgroundColor:
                currentStep >= 1 ? COLORS.primary : `${COLORS.textMuted}33`,
            },
          ]}
        />
        <View
          style={[
            ...
            {
              backgroundColor:
                currentStep >= 2 ? COLORS.primary : `${COLORS.textMuted}33`,
            },
          ]}
        />
        <View
          style={[
            ...
            {
              backgroundColor:
                currentStep >= 3 ? COLORS.primary : `${COLORS.textMuted}33`,
  ...
  const handleNext = async (action: "next" | "draft" | "publish" = "next") => {
    if (currentStep < 3) {
      ...
      try {
        ...
        const payload: any = {
          ...
          event_category: eventTier.toLowerCase(),
        };
        ...
        let response;
        if (isEditMode) {
          response = await partnerAPI.updateEvent(initialData._id, payload);
        } else {
          response = await partnerAPI.createEvent(payload);
        }
              ...
              <>
                <TouchableOpacity
                  style={[
                    ...
                    { marginLeft: 12, borderColor: COLORS.primary },
                  ]}
                  onPress={() => handleNext("draft")}
                  disabled={loading}
                >
                  <Text
                    style={[
                ...
                <TouchableOpacity
                  style={[
                    styles.mainButton,
                    { flex: 2, marginLeft: 12 },
                    loading && { opacity: 0.7 },
                  ]}
                  onPress={() => handleNext("publish")}
                  disabled={loading}
                >
                  {loading ? (
