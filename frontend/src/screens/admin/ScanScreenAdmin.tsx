...
export const ScanScreenAdmin = ({ navigation }: any) => {
    ...
    <View style={styles.container}>
      ...
      <View style={[styles.header, { paddingTop: insets.top + 10 }]}>
        ...
        <View style={styles.headerTitleContainer}>
          ...
          <Text style={styles.systemVersion}>ADMIN MODE</Text>
        </View>

        <TouchableOpacity
          style={styles.iconButtonBlur}
          onPress={() => showPopup("info", "How to Scan", "Point your camera at a QR code to scan match or payment QR codes.")}
        >
