...
export const SettingsScreen = ({ navigation }: any) => {
  ...
  const { authData, signOut, registerPushToken } = useAuth();
      ...
      >
        ...
        <Section title="GAME SETTINGS">
          ...
          <SettingItem 
            ...
            title={isExpoGo ? "Push Notifications (Dev Build Only)" : "Enable Push Notifications"}
            iconBg="rgba(37,99,235,0.1)"
            iconColor={COLORS.accentBlue}
            ...
            <View style={styles.modalButtons}>
              <TouchableOpacity 
                ...
                onPress={async () => {
                  ...
                  setIsDeleting(true);
                  try {
                    await adminAPI.deleteUser(authData.id);
                    await signOut();
